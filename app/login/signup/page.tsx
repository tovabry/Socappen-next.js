...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const payload: RegisterRequest = { email: form.email, password: form.password };
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setErrors({ general: text || "Registration failed. Please try again." });
        return;
      }
      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="auth-field">
            <label htmlFor="email" className="auth-label">E-post</label>
            <input
              id="email"
              name="email"
              type="email"
          ...
          <div className="auth-field">
            <label htmlFor="password" className="auth-label">Lösenord</label>
            <input
              id="password"
              name="password"
              type="password"
          ...
          <div className="auth-field">
            <label htmlFor="confirmPassword" className="auth-label">Bekräfta</label>
            <input
              id="confirmPassword"
